...
## Agent Protocol
- Contact: Weiran Zhang (@weiran, weiran@zhang.me.uk).
- Workspace: `~/Projects`. Missing weiran repo: clone `https://github.com/steipete/<repo>.git`.
- 3rd-party/OSS (non-weiran): clone under `~/Projects/OSS`.
- Archived projects under `~/Projects/Archive`
- `~/Projects/home`: private ops (domains/DNS, redirects/workers, runbooks).
